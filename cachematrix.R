        ...
        if (is.null(x)) {
                ...
                if(!is.null(i)) {
                        if (identical(x$getrefmat(),x$getmat())) {
                                ...
                                #compute the inverse matrix after the source matrix has changed
                                message("computing the inverse matrix after the source matrix has changed")
